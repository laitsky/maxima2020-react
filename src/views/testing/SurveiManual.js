...
import FormComponent from './stepComponents';
      ...
      >
        ...
        >
          <Box className="step-aligner">
            ...
            <span className="step-title-radio">
              STATE membantu saya untuk mengenali UKM/ Media Kampus
              yang saya minati.
            </span>
            <Box display="flex" flexDirection="row">
              <input
            ...
            <span className="step-title-radio">
              Materi yang disampaikan saat STATE 2020 sangat
            ...
            <span className="step-title-radio">
              STATE sangat mempengaruhi keputusan saya untuk mengikuti
              UKM/ Media Kampus yang saya pilih
            </span>
            <Box display="flex" flexDirection="row">
              <input
                type="radio"
            ...
            <span className="step-title-input">
              Apakah materi yang disampaikan sesuai dengan harapan
              kamu? Kenapa?
            </span>
            <MxmTextArea
            ...
            >
              <Box className="step-aligner">
                ...
                <label htmlFor="bergabung" className="step-label">
                  Memilih untuk bergabung dengan UKM/ Media Kampus
                  yang saya pilih
                </label>
                <input
                  type="radio"
                ...
                <label htmlFor="nobergabung" className="step-label">
                  Memilih untuk tidak bergabung dengan UKM/ Media
                  kampus yang saya pilih
                </label>
              </Box>
            </Box>
          </Box>
